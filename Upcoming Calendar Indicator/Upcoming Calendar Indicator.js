...
//   log(month)
  for (let i = 0; i < month.length; i += 1) {
    ...
    for (let j = 0; j < month[i].length; j += 1) {
      ...
      dateStackUp.size = new Size(22, 15);
      dateStackUp.centerAlignContent();   
      dateStack.size = new Size(22, 21);
