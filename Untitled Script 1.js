...
const apiKey = "5a8fd3de042f3b446d199ed072a567d5"
...
const localizedText = {
  ...
  nightGreeting: "Good night, Rayan."
  ,morningGreeting: "Good morning, Rayan."
  ,afternoonGreeting: "Good afternoon, Rayan."
  ,eveningGreeting: "Good evening, Rayan."
...
const textFormat = {
  ...
  defaultText: { size: 14, color: "000000", font: "regular" },
...
// log("sunrise is "+sunrise+ " sunset is "+sunset)
...
async function sunrise(column) {
  ...
  // Requirements: sunrise
  if (!sunData) { await setupSunrise() }
  log("sunrise " + sunData.sunrise+".  sunset "+sunData.sunset)
  const sunrise = sunData.sunrise
  const sunset = sunData.sunset
...
$$$$$$$$$$$$$$$$$   
---------------------------------*/    
const symbol2Name = "sunset.fill"
const symbol2 = sunriseStack.addImage(SFSymbol.named(symbol2Name).image)
  symbol2.imageSize = new Size(22,22)
  tintIcon(symbol2, textFormat.sunrise)
  
  sunriseStack.addSpacer(padding)
  
  // Add the time.
   const timeText2 = formatTime(new Date(sunset))
   const time2 = provideText(timeText2, sunriseStack, textFormat.sunrise)
